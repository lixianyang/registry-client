...
type Repository interface {
	...
	ManifestV1(ctx context.Context, reference string) (*schema1.SignedManifest, error)
	ManifestV2(ctx context.Context, reference string) (*schema2.DeserializedManifest, error)
}
...
func (r *repository) manifest(ctx context.Context, ref string, m json.Unmarshaler, modifier RequestModifier) error {
	namedTagged, err := reference.WithTag(r.name, ref)
	if err != nil {
		return err
	}

	manifestURLStr, err := r.ub.BuildManifestURL(namedTagged)
	if err != nil {
		return err
	}
...
func (r *repository) ManifestV1(ctx context.Context, ref string) (*schema1.SignedManifest, error) {
	manifest := &schema1.SignedManifest{}
	err := r.manifest(ctx, ref, manifest, func(req *http.Request) {
		req.Header.Set("Accept", schema1.MediaTypeManifest)
	})
	return manifest, err
}

func (r *repository) ManifestV2(ctx context.Context, ref string) (*schema2.DeserializedManifest, error) {
